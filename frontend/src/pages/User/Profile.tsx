  ...
  return (
    <div className="flex flex-col h-screen bg-[#070b13] overflow-y-auto custom-scrollbar">
      ...
      <div className="flex-1 max-w-5xl w-full mx-auto p-6 md:p-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">Hồ sơ Của bạn</h1>       
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="glass-panel p-8 rounded-3xl border border-slate-800 shadow-xl">
              <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6 pb-4 border-b border-slate-800 flex items-center gap-2">
